...
func memLayouts(model int) {
	...
	// MEM.Layouts[0].Attach("SLOT1", 0xC100, SLOT1, mem.READONLY)
	// MEM.Layouts[0].Attach("SLOT2", 0xC200, SLOT2, mem.READONLY)
	// MEM.Layouts[0].Attach("SLOT3", 0xC300, SLOT3, mem.READONLY)
	// MEM.Layouts[0].Attach("SLOT4", 0xC400, SLOT4, mem.READONLY)
	// MEM.Layouts[0].Attach("SLOT5", 0xC500, SLOT5, mem.READONLY)
	MEM.Layouts[0].Attach("SLOT6", 0xC600, SLOT6, mem.READONLY)
	// MEM.Layouts[0].Attach("SLOT7", 0xC700, SLOT7, mem.READONLY)
