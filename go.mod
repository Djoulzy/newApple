...
require (
	...
	github.com/Djoulzy/emutools/mem/v2 v2.0.0-20221019163223-dc6f2bf8d77f
...
replace (
	github.com/Djoulzy/emutools/mem/v2 v2.0.0-20221019163223-dc6f2bf8d77f => ../github.com/Djoulzy/emutools/mem/v2
