...
require (
	...
	github.com/Djoulzy/emutools/mos6510 v0.0.0-20240201175417-590543867037
	github.com/Djoulzy/emutools/render v0.0.0-20240201175417-590543867037
	github.com/Djoulzy/godsk v0.0.0-20230918100154-614368a3a7c0
	github.com/Djoulzy/gowoz v0.0.0-20230913121504-97232d4d9c93
	github.com/Djoulzy/mmu v0.0.0-20240201181512-4675c1de8e58
	github.com/mattn/go-tty v0.0.5
)

require (
	github.com/Djoulzy/emutools/charset v0.0.0-20240201175417-590543867037 // indirect
